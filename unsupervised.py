def run_unsupervised(): 
	...
	# In[40]:
	# 1. Identify the last 15 features (TARs and Global TAR)
	last_15_cols = profile_cols[-15:]
	
	# 2. Subset the DataFrame (keep clusters/stages for hue)
	# We add the categorical columns back to the list of feature columns
